...
def sendMessage(mail, user, name):
    ...
    #msg = Message('Codigo QR Chico Talento',sender=getenv('USER_MAIL'),recipients=[user])
    msg = Message('Codigo QR Chico Talento',sender='systeplusunimag@gmail.com', recipients=[user])
